...
本批報告追蹤一項統計模型如何被組裝成可購買的 AI 商品，再被介面、評測、資本與組織流程賦予經濟意義。核心主張不是「市場受騙」，而是敘事能協調完成產品所需的投資與改造；它是否成立，最後仍受效用、成本與責任約束。
...
模型能力只有在基礎設施中被穩定供應，並嵌入一個承擔例外與責任的組織，才成為產品。Demo 與 Benchmark 讓不可直接檢查的能力變得可比較，資本再依據這些訊號和未來假設配置資源。

資源可以改善產品，也可能只放大成本。以下報告因此將「敘事」「生產」與「驗證」分開：敘事能啟動迴圈，實際效用才能使迴圈持續。
