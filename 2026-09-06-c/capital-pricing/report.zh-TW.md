...
把風險投資與華爾街統稱為炒作，會漏掉資本工具、時間尺度與退出方式的差異。敘事的作用是替不確定情境配置機率，而非憑空取消現金流約束。

## 分析 (Analysis)

公開企業常用的基本估值語言是折現現金流（discounted cash flow）：
...
公開市場也會定價選擇權，創投也會估計現金流；兩者並非絕對分類。差異主要來自公司階段、資訊可得性、流動性與投資契約。
...
折現現金流與風險配對可參考 Aswath Damodaran 的 [Valuation](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/val.html)；私募與創投反推退出價值的差異見 [Private Firm Expansion](https://pages.stern.nyu.edu/adamodar/New_Home_Page/invfables/privateequity.htm)。
