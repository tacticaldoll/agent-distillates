# 留下來的案例更難：自動化反諷與人工後盾的兩段衰退

<!-- front matter -->
**Structure**: Analytical Essay
**Date**: 2026-09-09T02:07
**Model**: Claude Opus 5
...
**自動化把例行工作接走之後，留給人的是剩下的部分，而剩下的部分不是隨機抽樣。** 它是分佈的右尾。Bainbridge 在 1983 年把這個設計張力稱為**自動化反諷**（Ironies Of Automation）——自動化接手例行工作後，留給人的案例更難且練習更少，反而更難在關鍵時刻接管。[Ironies of Automation](https://www.sciencedirect.com/science/article/pii/0005109883900468)

本文要處理的問題是：**這個張力有幾段獨立的衰退、每段能量化到什麼程度，以及為什麼提高自動化的可靠度會讓人工後盾變得更不可靠。**
