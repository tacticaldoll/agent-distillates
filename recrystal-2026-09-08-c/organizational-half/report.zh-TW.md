# 組織那一半的因果：同一個工具為何產生相反的結果

<!-- front matter -->
**Structure**: Analytical Essay
**Date**: 2026-09-09T01:49
**Model**: Claude Opus 5
...
**技術與組織互補**（Organizational Complementarity）指技術能力必須搭配流程重排與技能調整才形成產出。用一個乘法形式表達：
...
共同生產還包含**人工補償**（Human Compensation）——以人力審核與例外處理填補模型不可靠之處，使系統整體達到可交付品質的做法。員工核對、改寫、找資料與處理例外，這些時間存在，但通常不記在任何項目下。

下圖把隱形工作與**資料回流**（Data Feedback Loop）放回系統裡。資料回流是使用者接受、修改或拒絕的紀錄回到產品與流程更新，進而改變後續系統行為的循環。
...
生產力不是模型隨安裝附送的常數。它由模型品質、流程適配、技能分佈、人工補償與資料回流共同生產，而其中至少三項不在任何 AI 產品的規格表上。
