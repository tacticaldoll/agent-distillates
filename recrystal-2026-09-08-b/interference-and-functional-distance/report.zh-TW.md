# 新任務如何改寫舊行為：共享方向上的干涉與功能距離

<!-- front matter -->
**Structure**: Analytical Essay
**Date**: 2026-09-08T22:31
**Model**: Claude Opus 5
...
若內積為負，這一步在局部提高舊損失。因果鏈是：兩任務共用關鍵參數方向 → 新任務梯度與舊任務梯度在該方向相衝 → 更新移動決策邊界 → 舊任務行為翻轉。這個量叫**梯度干涉**（gradient interference），而它是可以直接量測的。
